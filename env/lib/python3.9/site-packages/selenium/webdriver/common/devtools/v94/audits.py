...
class InspectorIssueDetails:
    ...
    wasm_cross_origin_module_sharing_issue: typing.Optional[
    ...
    def to_json(self):
        ...
        if self.wasm_cross_origin_module_sharing_issue is not None:
            ...
            ] = self.wasm_cross_origin_module_sharing_issue.to_json()
        return json
    ...
    def from_json(cls, json):
        return cls(
            ...
            wasm_cross_origin_module_sharing_issue=WasmCrossOriginModuleSharingIssueDetails.from_json(
                json["wasmCrossOriginModuleSharingIssue"]
            )
            if "wasmCrossOriginModuleSharingIssue" in json
            else None,
        )
